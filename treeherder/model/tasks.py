...
from treeherder.model.bug_suggestions import load_bug_suggestions
...
def populate_bug_suggestions(project, artifacts, job_id_lookup):
    """
    ...
    load_bug_suggestions(project, artifacts, job_id_lookup)
